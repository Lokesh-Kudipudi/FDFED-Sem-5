...
describe('bookingController.js tests', () => {
  it('should have unit test for getUserBookings', async () => {
    const req = mockReq();
    const res = mockRes();
    
    try {
      await controller.getUserBookings(req, res);
    ...
    expect(typeof controller.getUserBookings).toBe('function');
  });
});
