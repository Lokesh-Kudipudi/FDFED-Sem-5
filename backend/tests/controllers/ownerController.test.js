...
describe('ownerController.js tests', () => {
  it('should have unit test for getHotelIdsByOwnerId', async () => {
    const req = mockReq();
    const res = mockRes();
    
    try {
      await controller.getHotelIdsByOwnerId(req, res);
    ...
    expect(typeof controller.getHotelIdsByOwnerId).toBe('function');
  });
});
