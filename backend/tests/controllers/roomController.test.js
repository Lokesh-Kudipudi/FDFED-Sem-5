...
const controller = require('../../Controller/roomController.js');
...
describe('roomController.js tests', () => {
  it('should have unit test for createRoom', async () => {
    const req = mockReq();
    const res = mockRes();
    ...
    expect(typeof controller.createRoom).toBe('function');
  });
});
