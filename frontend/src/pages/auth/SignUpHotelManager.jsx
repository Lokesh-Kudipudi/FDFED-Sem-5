...
const SignUpHotelManager = () => {
  ...
  return (
    <AuthLayout backgroundImage="https://www.tripsavvy.com/thmb/gDYDVvjwO5oQxcE_x4lfmqOdLQ8=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-545247233-5bb7e6a146e0fb0026919fb4.jpg">
      <AuthCard
        imageSrc="https://www.tripsavvy.com/thmb/gDYDVvjwO5oQxcE_x4lfmqOdLQ8=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-545247233-5bb7e6a146e0fb0026919fb4.jpg"
        imageAlt="Enjoy the World"
        className="h-[580px] max-w-[1000px]"
        imageClassName="object-cover"
      >
        
        <AuthHeader
          title="Create Account - Hotel Manager"
